...
public abstract class AbstractReportBuilder {
	...
	public final byte[] builder() throws Exception {
		...
		issue_count = String.valueOf(header.get("issue_count"));
		file_count = String.valueOf(header.get("file_count"));
		extend_issue = String.valueOf(header.get("extend_issue"));
		...
		for (Map<String, String> bo : body) {
			...
			report.setMessage(bo.get("message"));
	...
	protected final String getProject_number() {
		return project_number == null ? "" : project_number;
	}

	protected final String getProject_language() {
		return project_language == null ? "" : project_language;
	}

	protected final String getProject_url() {
		return project_url == null ? "" : project_url;
	}

	protected final String getProject_desc() {
		return project_desc == null ? "" : project_desc;
	}

	protected final String getPlan_number() {
		return plan_number == null ? "" : plan_number;
	}

	protected final String getStar_time() {
		return star_time == null ? "" : star_time;
	}
	...
	protected final String getIssue_count() {
		return issue_count == null ? "" : issue_count;
	}

	protected final String getFile_count() {
		return file_count == null ? "" : file_count;
	}

	protected final String getExtend_issue() {
		return extend_issue == null ? "" : extend_issue;
	}

	protected final String getResolution_rate() {
		return resolution_rate == null ? "" : resolution_rate;
	}
	...
	protected class Report {
		...
		protected final String getCheck_name() {
			return check_name == null ? "" : check_name;
		}
		...
		protected final String getMainCodeBeginLine() {
			return mainCodeBeginLine == null ? "" : mainCodeBeginLine;
		}

		protected final String getBegin_line() {
			return begin_line == null ? "" : begin_line;
		}

		protected final String getEnd_line() {
			return end_line == null ? "" : end_line;
		}
