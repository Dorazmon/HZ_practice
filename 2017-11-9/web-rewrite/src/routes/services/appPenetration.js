        ...
        <div className="mainTest">
            <div className="mainTest_ALL">
              <div className="mainTest_content_app"> <h1>检测要点</h1>
                ...
                <li>LDAP注入</li><li>OS命令注入</li><li>弱加密算法</li><li>CORS攻击</li>
                <li>SSL隧道明文信息检查</li>
                ...
                <li>密码修改测试</li><li>Service劫持</li><li>使用持久性Cookies</li>
                ...
                <li>绕过证书绑定</li><li>忽略SSL证书错误</li>
                <li>弱自定义Hostname Verifier</li><li>冗余授予的权限</li><li>恶意Activity/Service调用</li>
                <li>Smbols Remnant</li>
                <li>不安全网络sockets的使用</li><li>服务端检查</li><li>应用程序会话管理检查</li>
                <li>跨域脚本攻击</li><li>Cookies的路径属性设置检查</li>
                ...
                <li>证书链没有被验证</li><li>未显示最近登录信息</li><li> Cookie的Secure属性检查</li>
                ...
                <li>响应中包含明文密码</li><li>直接引入未认证的内部资源</li><li>IOS snapshot/backgrounding</li>
                <li>服务端不当的输入验证</li><li>CSRF/SSRF检查</li><li>可缓存的HTTPS响应内容</li><li>Cookie的HttpOnly属性检查</li><li>Autocomplete没有设置<p>为OFF</p></li><li>应用程序只能允许HTTP GET<p>和POST方法</p></li><li>用户认证时使用可欺骗的值，<p>如IMEI,UDID</p></li><li>在未加密的通道上中转第三<p>方数据</p></li><li>详细的错误信息导致内部的<p>敏感信息泄漏</p></li><li>Unix domain sockets的<p>不安全权限</p></li><li>应用程序可以在被ROOT或<p>越狱手机中使用</p></li>
              </ul>   
              </div>
