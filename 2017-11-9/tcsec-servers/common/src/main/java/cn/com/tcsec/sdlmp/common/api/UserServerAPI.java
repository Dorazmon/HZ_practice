...
public interface UserServerAPI {
	 ...
	 */
	@AccessControl(enable = true, method = true, paramIndex = { 1 }, cycle = 10, count = 4)
	...
	Object getUserIdByPhone(@ParamCtrl(regex = REGEX.phone) @JsonRpcParam(value = "phone") String phone);
	 ...
	 */
	@AccessControl(enable = true, method = true, paramIndex = { 1 }, cycle = 5, count = 1)
	...
	@AccessControl(enable = true, method = true, paramIndex = { 1 }, cycle = 60, count = 1)
	 ...
	 * @return 登录成功返回用户权限，登录失败返回空
	 */
	@AccessControl(enable = true, method = true, paramIndex = { 1, 2 }, cycle = 60, count = 1)
	...
	Object setUserPhone(@ParamCtrl(regex = REGEX.userID) @JsonRpcParam(value = "user_id") String user_id,
			@ParamCtrl(regex = REGEX.phone, must = false) @JsonRpcParam(value = "phone") String phone);
	 ...
	 */
	@AccessControl(enable = true, method = true, paramIndex = { 2 }, cycle = 10, count = 1)
	 ...
	 */
	@AccessControl(enable = true, method = true, paramIndex = { 2 }, cycle = 60 * 60 * 24, count = 1)
