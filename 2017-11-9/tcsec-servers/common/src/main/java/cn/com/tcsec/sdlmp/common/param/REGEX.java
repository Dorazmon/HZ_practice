...
final public class REGEX {
	public static void main(String[] args) {
		// System.out.println(Pattern.compile(projectUrl).matcher("git@github.com:tcsecchen/CodeIgniter.git").matches());
		// System.out.println(Pattern.compile(oauthId).matcher("gith25191604").matches());
	}
	...
	public final static String oauthChannel = "(osch)|(csdn)|(gith)";
	public final static String oauthId = "(^osch[a-zA-Z0-9_-]{2,40}$)|(^csdn[a-zA-Z0-9_-]{2,40}$)|(^gith[a-zA-Z0-9_-]{2,40}$)";
	...
	public final static String reportType = "(pdf)|(exc)";
