...
class Footer extends React.Component {
  ...
  render() {
    ...
    delete props.isMode;
    const logoContent = { img: '/static/img/codelogo.png', content: '让 世 界 互 联 更 安 全' };
    const dataSource = [
      { title: '支持', content: 'API文档\n快速入门\n帮助&支持\n产品价格', contentLink: '/expected\n/expected\n/expected\n/expected' },
      { title: '关于', content: '关于我们\n加入我们\n法律声明', contentLink: '/about/us\n/about/recruitment' },
    ...
    >
      <QueueAnim type="bottom" component="ul" key="ul" leaveReverse id={`${props.id}-ul`} className="codeFooter">
        <li key="logo" id={`${props.id}-logo`}>
          <p className="logo">
            <a href="/"><img src={logoContent.img} /></a>
          </p>
          <p className="logo_text">{logoContent.content}</p>
        </li>
        {liChildrenToRender}
