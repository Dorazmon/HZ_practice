  ...
  render() {
    return (
      <div className="templates-wrapper">
        ...
        <div className="web">
        <div className="banner"><h1>安全等级保护</h1></div>
        ...
        <div className="safety_assessment">
          <h1>服务内容</h1>
          <p style={{width: '90%', margin: '20px auto -10px' }}>等级保护服务内容涵盖十大类，技术要求：物理安全、网络安全、主机安全、应用安全和数据安全；管理要求：安全管理制度、安全管理机构、人员安全管理、系统建设管理和系统运维管理，具体实施流程及工作如下所示：</p>      
        </div>
        </div>
